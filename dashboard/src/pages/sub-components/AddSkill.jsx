...
const AddSkill = () => {
  ...
  return (
    <>
      <div className="flex justify-center items-center min-h-[100vh] sm:gap-4 sm:py-4 sm:pl-14 bg-black">
        <form
        ...
        >
          <div className="space-y-12">
            <div className="border-b border-gray-900/10 pb-12">
              <h2 className="font-semibold leading-7 text-yellow-500 text-3xl text-center">
                ADD A NEW SKILL
              </h2>
