          ...
          <div className="grid w-[100%] gap-6">
            ...
            <div className="grid gap-4">
              ...
              <div className="grid gap-2">
                ...
                <Input
                  type="text"
                  className="Your Full Name  text-yellow-500 bg-slate-800"
                  value={fullName}
              ...
              <div className="grid gap-2">
                ...
                <Input
                  type="email"
                  className="Your Email Address text-yellow-500 bg-slate-800"
                  value={email}
              ...
              <div className="grid gap-2">
                ...
                <Input
                  type="text"
                  className="Phone Number text-yellow-500 bg-slate-800"
                  value={phone}
              ...
              <div className="grid gap-2 ">
                ...
                <Textarea
                  className="About Me text-yellow-500 bg-slate-800"
                  value={aboutMe}
              ...
              <div className="grid gap-2 ">
                ...
                <Input
                  type="text"
                  className="Portfolio URL text-yellow-500 bg-slate-800"
                  value={portfolioURL}
                  onChange={(e) => setPortfolioURL(e.target.value)}
                />
              </div>

              <div className="grid gap-2 text-yellow-500 bg-slate-800">
                <Label>LinkedIn URL</Label>
                <Input
                  type="text"
                  className="LinkedIn URL text-yellow-500 bg-slate-800"
                  value={linkedInURL}
              ...
              <div className="grid gap-2">
                ...
                <Input
                  type="text"
                  className="Github URL text-yellow-500 bg-slate-800"
                  value={githubURL}
              ...
              <div className="grid gap-2">
                ...
                <Input
                  type="text"
                  className="Instagram URL text-yellow-500 bg-slate-800"
                  value={instagramURL}
              ...
              <div className="grid gap-2">
                ...
                <Input
                  type="text"
                  className="Twitter(X) URL text-yellow-500 bg-slate-800"
                  value={twitterURL}
              ...
              <div className="grid gap-2">
                ...
                <Input
                  type="text"
                  className="Facebook URL text-yellow-500 bg-slate-800"
                  value={facebookURL}
