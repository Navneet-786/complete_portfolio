...
const AddProject = () => {
  ...
  return (
    <>
      <div className="flex text-white justify-center items-center min-h-[100vh] sm:gap-4 sm:py-4 sm:pl-14 bg-black">
        <form
          onSubmit={handleAddNewProject}
          className="w-[100%] px-5 md:w-[1000px] text-white"
        >
          <div className="space-y-12">
            <div className="border-b border-gray-900/10 pb-12">
              <h2 className="font-semibold leading-7 text-yellow-500 text-3xl">
                ADD NEW PROJECT
              </h2>
              <div className="mt-10 flex flex-col gap-5">
                <div className="w-full sm:col-span-4">
                  ...
                  <div className="mt-2">
                    <div className="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600">
                      <input
                        type="text"
                        className="block flex-1 border-0 bg-transparent py-1.5 pl-1 text-black placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6 bg-white outline-none rounded-sm"
                ...
                <div className="w-full sm:col-span-4">
                  ...
                  <div className="mt-2">
                    <div className="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 text-black ">
                      <Select
                        value={stack}
                  ...
                  <div className="mt-2 flex justify-center rounded-lg border border-dashed border-slate-500 px-6 py-10 ">
                    <div className="text-center">
                      {projectBannerPreview ? (
                        ...
                        <svg
                          className="mx-auto h-12 w-12 text-yellow-300"
                          viewBox="0 0 24 24"
                          fill="currentColor"
                          aria-hidden="true"
                        >
